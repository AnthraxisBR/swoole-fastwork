...
class Regions
{
    ...
    public const us_east_1 = 'us-eas-1';
    ...
    public const cn_northwest_1 = 'cn-northwest_1';
    ...
    public const us_gov_east_1 = 'us-giv-east-2';

    public const us_gov_west_1 = 'us-gov-west-2';
}