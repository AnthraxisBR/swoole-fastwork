...
namespace AnthraxisBR\SwooleFW\CloudServices\GCP\Sdk\Firewalls;

/**
 * Auto generated class from google-docs-sdk-generator from AnthraxisBR
 */
class Firewalls extends \AnthraxisBR\SwooleFW\CloudServices\GCP\FwGoogleClient
{
	/**
	...
	public function Delete(string $requestId)
	{
		...
		$args[] = "{project}";
		$args[] = "{resourceId}";
		$url = $this->replaceUri('https://www.googleapis.com/compute/v1/projects/{project}/global/firewalls/{resourceId}', $args);
		$queryArgs = [];
		$queryArgs[] = $requestId;
	...
	public function Insert($data, string $requestId)
	{
		$args = [];
		$args[] = "{project}";
		$url = $this->replaceUri('https://www.googleapis.com/compute/v1/projects/{project}/global/firewalls', $args);
		$queryArgs = [];
		$queryArgs[] = $requestId;
		$url = $this->parseArgs($url, $queryArgs);
		$url = $this->prepareUrl($url);
